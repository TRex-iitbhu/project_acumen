...
###Raspi's data to the server
    ...
    url(r'^patchStatusUpdate/(?P<swarmBotId>\d+)/(?P<boolint>\d+)/$', patchStatusUpdate, name='patchStatusUpdate'),
    url(r'^sensor_readings/(?P<swarmBotId>\d+)/$', sensorReadView), #coming from raspis
